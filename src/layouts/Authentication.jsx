...
import authImage from '@assets/images/bg01.webp';
...
const Authentication = () => {
  ...
  return (
    <div>
      <div className='dark:!bg-navy-900 relative float-right size-full min-h-screen !bg-white'>
          ...
          <div className='relative flex'>
            <div className='mx-auto flex min-h-full w-full flex-col justify-start pt-12 md:max-w-[75%] lg:h-screen lg:max-w-[1013px] lg:px-8 lg:pt-0 xl:h-[100vh] xl:max-w-[1383px] xl:px-0 xl:pl-[70px]'>
              <div className='mb-auto flex flex-col px-5 md:pl-12 md:pr-0 lg:max-w-[48%] lg:pl-0 xl:max-w-full'>
                ...
                >
                  <div className='mx-auto flex size-fit items-center hover:cursor-pointer'>
                    <svg
                      width='8'
                      height='12'
                      viewBox='0 0 8 12'
